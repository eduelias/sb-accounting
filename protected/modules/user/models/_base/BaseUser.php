...
abstract class BaseUser extends SActiveRecord {
	...
	public function relations() {
		return array(
			...
			'empresas' => array(self::MANY_MANY, 'Empresa', 'empresa_user(iduser, idempresa)'),
			'fluxos' => array(self::HAS_MANY, 'Fluxo', 'iduser'),
			'fluxos1' => array(self::HAS_MANY, 'Fluxo', 'iduser_pgto'),
			...
			'relStatusNconfs' => array(self::HAS_MANY, 'RelStatusNconf', 'iduser'),
