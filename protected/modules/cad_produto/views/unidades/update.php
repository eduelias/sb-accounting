...
$this->breadcrumbs=array(
	...
	$model->idunidade=>array('view','id'=>$model->idunidade),
	'Editar',
);
$this->menu = array(
	...
	array('label'=>' | '), 
	array('label'=>' Ver  ', 'url'=>array('view', 'id'=>$model->idunidade)),
	array('label'=>' [Editar] '),
...
<h1><?php echo Yii::t('app', 'Update'); ?> CadProdutosUnidade #<?php echo GxHtml::encode(GxHtml::valueEx($model)); ?></h1>
